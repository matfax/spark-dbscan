...
val settings: DbscanSettings)
  ...
  /** Predicts which cluster a point would belong to
    ...
    *         [[dbscan.DbscanModel.NoisePoint]] is returned.
    *         If the point is surrounded by so many noise points that they can constitute a new
    *         cluster, then [[dbscan.DbscanModel.NewCluster]] is returned
    */
...
object DbscanModel {
  ...
  /** Indicates that a new cluster would appear in a [[dbscan.DbscanModel]] if
